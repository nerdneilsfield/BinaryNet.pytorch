...
class EmptyNoise(nn.Module):

    def __init__(self, layers=64, n=50, is_relative_detach=True, empty=True):
        super().__init__()
...
class VGG_FCBN(nn.Module):

    def __init__(self, num_classes=1000):
        super(VGG_FCBN, self).__init__()
        self.infl_ratio=1;
